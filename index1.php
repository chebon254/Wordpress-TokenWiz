                        ...
                        <div class="card-innr">
                            <div class="token-balance token-balance-with-icon">
                                <div class="token-balance-icon">
                                    <img src="<?php echo get_template_directory_uri(); ?>/images/logo-light-sm.png" alt="logo">
                                </div>
                        ...
                        <div class="row no-gutters height-100">
                            <div class="col-md-6 text-center">
                                <div class="token-info">
                                    <img class="token-info-icon" src="<?php echo get_template_directory_uri(); ?>/images/logo-sm.png" alt="logo-sm">
